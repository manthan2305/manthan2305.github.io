...
{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/example-image.png" class="example-image" %}
...
{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/allen_2022_model.png" class="allen-2022" %}
...
{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/cindm.png" class="cindm" %}
...
{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/cindm-method-intuition.png" class="cindm-intuition" %}
...
#### **Generalization to Longer Time Steps**:  
   ...
   {% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/exp1-int.png" class="exp1-int" %}
...
#### **Generalization to More Interacting Objects**:  
   ...
   {% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/exp2-int.png" class="exp2-int" %}
...
#### **Generalization from Parts to Whole for Boundaries**:  
   ...
   {% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/experiment2.png" class="experiment2" %}
...
{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/generation_process.gif" class="gen-process" %}
   figure 8 Generation Process

{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/generated_examples.gif" class="gen-example" %}
   figure 9 Generated Example

{% include figure.liquid loading="eager" path="assets/img/2025-02-10-cindm/adversarial-modes.png" class="admodes" %}
   figure 10 CinDM outperforms adversarial methods by generating designs that adhere to predefined constraints and objectives, enabling the creation of complex systems that generalize beyond the training data.
